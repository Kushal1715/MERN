...
exports.productValidation = [
  ...
  body('product_price')
    ...
    .isFloat({ min: 0 }).withMessage('price must be a positive numbers'),
...
exports.userValidation = [
  ...
  body('password')
    ...
    .matches(/[A-Z]/).withMessage('passworod must contain at least one uppercase alphabet')
    .matches(/[0-9]/).withMessage('passworod must contain at least one numeric value')
    .matches(/[@#$?_-]/).withMessage('passworod must contain at least one special character')
]
