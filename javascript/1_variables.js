...
// It is the default behaviour of javascript which raise the varirable declared with
// var and function declaration to the top of its scope.
// console.log(address);
// var address = "ktm";
// console.log(address);
...
//4. Variables declared with const are not hoisted.
//5. const is block scope.


//Characteristics of variables in javascript
//1. Mutability(change in origin eg: var and let)
//2. Scope(region where the variable is declared.)
//    i. Global scope
//    ii.Local scope
//        1.Function scope(region inside the curly bracket '{}' only in function)
//        2.Block scope(region inside the curly bracket'{}')
