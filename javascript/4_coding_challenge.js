...
// const markHigherBMI = (BMIOfMark,BMIOfJohn) =>{
//    return BMIOfMark > BMIOfJohn;
// }
// console.log(markHigherBMI(BMIOfMark,BMIOfJohn));
...
const avg1 = (96+120+89)/3;
const avg2 = (88+199+110)/3;
console.log(avg1);
console.log(avg2);

const result = (avg1,avg2) =>{
   if(avg1 >= 100 && avg1 > avg2){
      console.log('team 1 wins')
   }else if(avg2 >= 100 && avg2>avg1){
      console.log('team 2 wins');
   }else if(avg1>= 100 && avg1 === avg2){
      console.log('draw');
   }else{
